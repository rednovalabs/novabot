...
#   HUBOT_GITHUB_REPOS is a JSON hash of rooms:repos. i.e. {"foo":"bar"} will post links to repo bar when the message comes from channel foo
#
# Author:
#   tenfef
...
module.exports = (robot) ->
  ...
  robot.logger.info("Posting issues links to Github repos: " + process.env.HUBOT_GITHUB_REPOS)
